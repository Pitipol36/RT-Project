...
class Camera:
    def __init__(self) -> None:
        ...
        self.aperture_disk_u = rtu.Vec3()
        self.aperture_disk_v = rtu.Vec3()
    ...
    def init_camera(self,fAperture=0.0, fFocusDist=10.0):
        ...
        lens_radius = self.Lens.get_aperture() * 0.5
        self.aperture_disk_u = self.camera_frame_u * lens_radius
        self.aperture_disk_v = self.camera_frame_v * lens_radius
...
class Thinlens(Lens):
    def __init__(self, fAperture=0.0, fFocusDist=10.0) -> None:
        super().__init__()
